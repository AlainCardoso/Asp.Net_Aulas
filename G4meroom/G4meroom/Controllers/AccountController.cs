...
namespace G4meroom.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Country = model.Country, State = model.State, Name = model.Name, LastName = model.LastName, City = model.City, Birthday = model.Birthday };
